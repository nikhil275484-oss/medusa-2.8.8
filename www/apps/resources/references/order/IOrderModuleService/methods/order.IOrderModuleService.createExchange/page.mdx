...
slug: /references/order/createExchange
sidebar_label: createExchange
---
...
This documentation provides a reference to the `createExchange` method. This belongs to the Order Module.
