...
![Product Variant Details](https://res.cloudinary.com/dza7lstvk/image/upload/v1739813067/User%20Guide/Screenshot_2025-02-17_at_7.24.04_PM_deaj7w.png)
...
1. Click the "Create" button at the top right of the Variants section.
...
2. In the Variants section, click on the <InlineIcon Icon={EllipsisVertical} alt="three-dots" /> at the variant's right.
...
1. Go to its product's details page.
2. Click on the <InlineIcon Icon={EllipsisVertical} alt="three-dots" /> at the top right of the section.
...
3. Click on the <InlineIcon Icon={ArrowUpRightOnBox} alt="arrow" /> at the right of the section.
4. In the side window that opens:
